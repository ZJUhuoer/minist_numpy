...
def train(num_classes = 10, lr = 0.01, beta1 = 0.95, beta2 = 0.99, img_dim = 28, img_depth = 1, f = 7, num_filt1 = 1, num_filt2 = 1, batch_size = 100, num_epochs = 1, save_path = 'train.pkl'):
